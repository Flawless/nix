...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/flawless/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/flawless/bin" "/profile/bin" "/Users/flawless/.npm-packages/bin" "/Users/flawless/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
